   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("#000000", "#454545"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#454545"),
            arrow("#454545", "#1c1c1c"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#1c1c1c"),
            arrow("#1c1c1c", "#454545"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), "#454545"),
            --arrow("#889FA7", "#497B96"),
            ...
            arrow("#454545", "#1c1c1c"),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#1c1c1c"),
            arrow("#1c1c1c", "#454545"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#454545"),
            arrow("#454545", "#1c1c1c"),
            wibox.container.background(wibox.container.margin(clock, dpi(4), dpi(8)), "#1c1c1c"),
            arrow("#1c1c1c", "alpha"),
            --]]
            s.mylayoutbox,
        },
